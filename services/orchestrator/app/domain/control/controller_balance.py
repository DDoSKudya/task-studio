...
import httpx
from app.domain.control.controller_actions import (
    ensure_running,
    ensure_stopped,
...
from app.domain.telemetry.llm_signals import ollama_stop_reason
from app.domain.telemetry.metrics import HostMetrics
from app.domain.telemetry.ollama_probe import ollama_is_busy
