...
from app.domain.control.controller_actions import ensure_running, ensure_stopped
from app.domain.control.state import ControllerState
from app.domain.policy.policies import OrchestratorPolicies
from app.domain.telemetry.llm_signals import all_users_external
from app.domain.telemetry.metrics import HostMetrics
...
async def refresh_balancing_signals(
    *,
    ...
    from app.domain.telemetry import metrics as metrics_mod
