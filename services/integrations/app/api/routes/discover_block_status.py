...
from app.api.routes.discover_summaries import course_summary_from_raw
from studio_contracts.integration_schemas import ExternalCourseSummary, PlatformCatalogStatus
