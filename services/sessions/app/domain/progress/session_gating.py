...
from app.domain.lifecycle.session_completion import (
    session_completed,
    topic_assess_passed,
    topic_practice_passed,
)
from app.domain.lifecycle.session_passed import list_passed_step_ids
from app.domain.progress.session_gate_leave import ensure_can_leave_gated_step, position_index
from app.infra.models import Attempt, Session
from sqlalchemy import func, select
from sqlalchemy.ext.asyncio import AsyncSession
from studio_contracts.packs.manifest import PackPolicies
