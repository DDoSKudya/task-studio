...
from app.domain.lifecycle.session_skip import skip_study
from app.domain.progress.session_gating import _ensure_can_leave_gated_step
from app.domain.progress.session_progress import (
    apply_position,
...
from studio_contracts.packs.manifest import PhaseName, read_policies, resolve_position
