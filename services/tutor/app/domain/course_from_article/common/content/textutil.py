...
from app.domain.course_from_article.common.content.textutil_scalars import (
    _as_str,
    _combined_corpus,
    _excerpt_balanced,
    _join_string_list,
...
from studio_contracts.api.studio_schemas import CourseArticleVideo, CourseFromArticleRequest
