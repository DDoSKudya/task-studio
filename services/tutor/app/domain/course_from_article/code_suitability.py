...
from app.domain.course_from_article.course_profile import CourseProfile
...
def code_suitability_score(*, profile: CourseProfile, runtime: str) -> float:
    ...
    runtime_key = runtime.strip().casefold()
    if runtime_key in {"python", "javascript", "typescript", "go", "sql"}:
