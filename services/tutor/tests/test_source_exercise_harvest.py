...
from app.domain.course_from_article.normalize_outline import _normalize_theory_step
from app.domain.course_from_article.source_exercise_harvest import (
    harvest_markdown_exercises,
    harvest_sources,
    strip_theory_exercise_sections,
)
from app.domain.course_from_article.textutil_scalars import _excerpt_balanced
