...
<template>
  ...
  >
    ...
    <!-- eslint-disable vue/no-v-html -- studyBodyToHtml sanitizes the source before code highlighting. -->
    <div
      v-if="showBody"
      ref="studyHtmlEl"
      class="study-html"
    ...
    <div v-if="codeExamples.length" class="study-examples">
      <div v-for="(example, index) in codeExamples" :key="index" class="study-code">
        ...
        <!-- eslint-disable-next-line vue/no-v-html -- highlightStudyCode escapes source code before adding markup. -->
