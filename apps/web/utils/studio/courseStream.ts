...
export function mapCourseStageToUi(
  stage: string | null | undefined,
): CourseStageName | string {
  if (!stage) {
    return "analyze";
  }
  ...
  if (stage === "code_suitability" || stage === "consistency") {
    return "analyze";
  }
  return stage;
}
...
export function applyCourseStageEvent(
  ...
  if (event.type === "code_suitability_gate") {
